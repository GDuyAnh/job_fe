            ...
            <div class="flex items-start justify-between mb-6">
              <div class="flex-1">
                ...
                <div class="flex items-center gap-2 text-gray-600 mb-4">
                  ...
                  <span>{{ getLocationDisplayValue(job.location) }}</span>
                </div>
                <div class="flex items-center gap-4 text-sm text-gray-600 mb-4">
                  <div class="flex items-center gap-1">
                    <UIcon name="i-heroicons-tag" class="w-4 h-4" />
                    <span>{{ getCategoryDisplayValue(job.category) }}</span>
                  </div>
                  <div class="flex items-center gap-1">
                ...
                <div class="flex items-center gap-4 text-sm">
                  <UBadge variant="soft">
                    {{ getExperienceLevelDisplayValue(job.experienceLevel) }}
                  </UBadge>
              ...
              <UCard class="bg-[#f0f7ff] rounded-2xl shadow p-6">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-gray-900">{{
                      getEmploymentTypeDisplayValue(job.typeOfEmployment)
                    }}</span>
                  </div>
                  <div class="flex justify-between text-sm">
                    <span class="text-gray-600">{{
                    ...
                    <span class="font-medium text-gray-900">
                      {{ getCategoryDisplayValue(job.category) }}
                    </span>
                  </div>
                  <div class="flex justify-between text-sm">
                    <span class="text-gray-600">{{
                    ...
                    <span class="font-medium text-gray-900">
                      {{ getLocationDisplayValue(job.location) }}
                    </span>
                  </div>
...
// Create enum resolvers using the utility
const getCategoryDisplayValue = createEnumResolver(category)
const getExperienceLevelDisplayValue = createEnumResolver(ExperienceLevel)
const getEmploymentTypeDisplayValue = createEnumResolver(TypeOfEmployment)
const getLocationDisplayValue = createEnumResolver(location)
const getBenefitDisplayValue = createEnumResolver(JobBenefits)
